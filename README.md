At the moment, I am:
1. Studying data science + distributed systems at UCSD
...
- [Headlines](https://github.com/adityakakarla/headlines) - A Next.js website (with Stripe) for a service that brainstorms intelligent headlines for newsletters
...
- [Memori](https://github.com/adityakakarla/memori) - A Next.js website to save important recordings (voice -> text -> RAG) 
